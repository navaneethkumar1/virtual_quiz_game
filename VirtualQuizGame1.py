...
#     if qNo < qTotal:
#         mcq = mcqList[qNo]
#         img, bbox1 = cvzone.putTextRect(img, mcq.question, [150, 100], 1.5, 2, colorR=(255, 0, 0), offset=50, border=5, colorB=(255, 255, 255))
#         img, bbox2 = cvzone.putTextRect(img, mcq.choice1, [150, 250], 1.6, 2, colorR=(255, 0, 0), offset=50, border=5, colorB=(255, 255, 255))
#         img, bbox3 = cvzone.putTextRect(img, mcq.choice2, [700, 250], 1.6, 2, colorR=(255, 0, 0), offset=50, border=5, colorB=(255, 255, 255))
#         img, bbox4 = cvzone.putTextRect(img, mcq.choice3, [150, 400], 1.6, 2, colorR=(255, 0, 0), offset=50, border=5, colorB=(255, 255, 255))
#         img, bbox5 = cvzone.putTextRect(img, mcq.choice4, [700, 400], 1.6, 2, colorR=(255, 0, 0), offset=50, border=5, colorB=(255, 255, 255))
